'''
    ...
    When used for navigation, angles are expressed in degrees and minutes, where 1 degree = 60 minutes
'''
#  Angle.py
#  CA01
#  Amanda Bailey
...
class Angle():
    ...
    # Purpose:
    # Parameters: "degrees" is the number of degrees (and portions of degrees). It is a numeric 
    #             value (integer or float). 
    #             Optional,  defaults to zero if missing. Arrives invalidated, if present.
    # Returns: The resulting angle as degrees and portions of degrees as a single floating point 
    #      number, modulo 360
    ...
    # Exit conditions: The instance remains in the state it was in before the method
    #                  was invoked. No new instance is produced
    ...
    # Purpose: Sets the value of the instance based on a string that contains degrees and minutes
    # Parameters:
    # Returns: The resulting angle as degrees and portions of degrees as a single floating point 
    #            number.
    # State change: The instance is set to the specified value.
    # Exceptions: Type: ValueError
    #             Raised when: "angleString" violates the parameter specifications
    ...
    # Parameter: "angle" is an instance of Angle whose value is to be added to current
    #             instance. Mandated Arrives invalidated.
    # Returns: The resulting angle as degrees and portions of degrees as a single 
    ...
    # Purpose:Subtracts the value of the parameterized value from the current instance.
    # Parameters: "angle" is an instance of Angle whose value is to be subtracted from
    ...
    # Parameters: "angle" is an instance of Angle whose value is to be added to current 
    #                instance. Mandatory. Arrives invalidated.
    ...
    #             and y.y is the number of minutes 
    #            (modulo 60, no leading zeros), rounded to one decimal point
    # State change:No state change
    ...
    # Parameters: No parameter
    # Returns: A floating point number representing the degrees and minutes modulo 360, rounded to
    #             the nearest 1/10 minute.
    # State change: No state change
    # Exceptions: No exceptions are raised.
    def getDegrees(self):
        return self.degrees%360
